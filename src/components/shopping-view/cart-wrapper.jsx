...
const UserCartWrapper = ({ cartItems, setOpenCartSheet }) => {
  ...
  return (
    <div>
      <SheetContent className="px-4 overflow-auto sm:max-w-md w-full bg-white g-gradient-to-r from-[#F3F6D5] via-[#c5e8ce] to-[#FFFFFF] p-6 rounded-lg shadow-md">
        <SheetHeader>
        ...
        <section className="py-4 mt-4 bg-gray-100 rounded-sm">
