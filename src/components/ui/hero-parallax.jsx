...
export const HeroParallax = ({ products }) => {
  ...
  return (
    <div
      ref={ref}
      className="h-[300vh] py-40 overflow-hidden bg-custom-gradient-2 antialiased relative flex flex-col self-auto [perspective:1000px] [transform-style:preserve-3d]"
    >
      <Header />
      <motion.div
        style={{
  ...
  return (
    <div className="max-w-7xl relative mx-auto py-20 md:py-40 px-4 w-full left-0 top-0">
      ...
      <p className="max-w-2xl font-roboto font-thin text-base md:text-xl mt-8 dark:text-neutral-400">
        ...
        with footwear, accessories, and more. At Urban Store, we promise the
        fastest delivery, a seamless shopping experience, and a 7-day easy
        return policy to make your style journey effortless.
      </p>
    </div>
  );
};
