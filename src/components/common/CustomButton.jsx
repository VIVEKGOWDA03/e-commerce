...
const CustomButton = ({ text, icon, endIcon, onClick, navigateTo }) => {
  ...
  return (
    <button
      onClick={handleClick}
      className="flex w-full justify-between items-center font-roboto gap-2 px-4 py-2 rounded-md  text-black hover:bg-blue-600 transition duration-300 ease-in-out"
    >
